					...
					<div class="col-sm-12">
						<table class="table table-hover">
							...
							<tr valign="middle" >
								...
								<td>${order.orderNo }</td>
								<td class="product-image-thumb active" onclick="OpenWindow('detail.do?id=${order.orderNo}', '', '800', '900');">
									<img src="/order/getPicture.do?picture=${order.picture}" class="img-fluid mb-2" alt="img">
								</td>
								<td onclick="OpenWindow('/prod/detail.do?id=${order.prodId}', '', '800', '900');">${order.prodName }</td>
								<td>
									<div class="row">
										<div class="col-sm-2"></div>
										<div class="col-sm-8">
											<input type="text" class="form-control" name="orderQty" value="${order.orderQty }" >
										</div>
										<div class="col-sm-2">
