...
public class MemberController {
	...
	public String modify(MemberModifyCommand modifyReq, HttpSession session, Model model) throws Exception {
		...
		model.addAttribute("member", memberService.getMember(modifyReq.getId())); // DB에 있는 정보를 가져온다.
	...
	public ModelAndView mailPost(@ModelAttribute("mailRequest") MailRequestCommand mail, HttpServletRequest request,
			ModelAndView mnv) throws Exception {
//		String url = "member/mail_success"; 화면결정은 service에서 한다. 
		
		//이 Controller에서는 service에서 보내줄 model을 작업을 한다.
