  ...
  <!-- Content Wrapper. Contains page content -->
	<div class="content-wrapper">
		...
		<div class="content-wrapper">
			...
			<div class="col-sm-8">
			<h5 class="m-0">회원등록하기</h5>
			<hr>
				<form action="/MyServlet/MemberInfoInsertAdminServlet" method="post"
					id="login-form">
					<div class="form-group">
						<label class="label-control"> <span class="label-text">ID</span>
						</label> <input type="text" name="memId" class="form-control" />
					</div>
					<div class="form-group">
						<label class="label-control"> <span class="label-text">Password</span>
						</label> <input type="password" name="memPass" class="form-control" />
					</div>
					<div class="form-group">
						<label class="label-control"> <span class="label-text">Name</span>
						</label> <input type="text" name="memName" class="form-control" />
					</div>
					<div class="form-group">
						<label class="label-control"> <span class="label-text">HP</span>
						</label> <input type="text" name="memHp" class="form-control" />
					</div>
					<div class="form-group">
						<label class="label-control"> <span class="label-text">Email</span>
						</label> <input type="email" name="memEmail" class="form-control" />
					</div>
