...
<div class="wrapper">
  ...
  <!-- Content Wrapper. Contains page content -->
	...
	<div class="content-wrapper">
		...
		<div class="col-sm-8">
			<h4>${mv.memName} 회원의 정보</h4>
			<form id="fm">
				<div class="form-group">
					<label for="memId">I D:</label> <input type="text" class="form-control" id="memId" value="${mv.memId}" name="memId" disabled="disabled">
				</div>
				
				<div class="form-group">
					<label for="memPass">비밀번호:</label> <input type="text" class="form-control" id="memPass" value="${mv.memPass}" name="memPass" disabled="disabled">
				</div>
				
				<div class="form-group">
					<label for="memName">이름 :</label> <input type="text" class="form-control" id="memName" value="${mv.memName}" name="memName" disabled="disabled">
				</div>
				
				<div class="form-group">
					<label for="memHp">전화번호:</label> <input type="text" class="form-control" id="memHp" value="${mv.memHp}" name="memHp" disabled="disabled">
				</div>
				
				<div class="form-group">
					<label for="memEmail">이메일:</label> 
					<input type="text"class="form-control" id="memEmail" value="${mv.memEmail}" name="memEmail" disabled="disabled">
				</div>

				<a href="/MyServlet/MemberInfoUpdateServlet?memId=${mv.memId }">정보수정</a>
			</form>
		</div>
		<div class="col-sm-2"></div>
	</div>
...
function update() {	
	...
	fm.method = "get";
	fm.action = "/MyServlet/MemberInfoUpdateServlet?memId="+memId
	fm.submit();	
}
</script>
</body>
