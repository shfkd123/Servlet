...
//	picture.style.backgroundImage="url('/member/getPicture.do?picture=${member.picture}')"; //절대경로
	picture.style.backgroundImage="url('getPicture.do?picture=${member.picture}')"; //상대경로
	picture.style.bacgroundPosition="center";
